#!/usr/bin/env python3
"""
Bing.com Connectivity Checker
This script checks if bing.com is accessible using multiple methods.
"""
...
class BingConnectivityChecker:
    ...
    def check_http_connectivity(self):
        ...
        try:
            print("🔍 Checking HTTP connectivity to bing.com...")
            response = requests.get(self.url, timeout=self.timeout)
            
            if response.status_code == 200:
                print(f"✅ SUCCESS: Bing.com is UP!")
                print(f"   Status Code: {response.status_code}")
                print(f"   Response Time: {response.elapsed.total_seconds():.2f} seconds")
                return True
            else:
                print(f"⚠️  WARNING: Bing.com responded with status code: {response.status_code}")
                return False
    ...
    def check_socket_connectivity(self):
        ...
        try:
            print("🔍 Checking socket connectivity to bing.com...")
            
            # Get IP address of bing.com
            host = "www.bing.com"
            port = 80
            ...
            if result == 0:
                print(f"✅ SUCCESS: Socket connection to bing.com established!")
            ...
            print("❌ ERROR: DNS resolution failed - Cannot resolve bing.com")
            return False
    ...
    def check_dns_resolution(self):
        """Check if bing.com can be resolved via DNS"""
        try:
            print("🔍 Checking DNS resolution for bing.com...")
            
            ip_address = socket.gethostbyname("www.bing.com")
    ...
    def run_comprehensive_check(self):
        ...
        print("=" * 60)
        print("🌐 BING.COM CONNECTIVITY CHECKER")
        print("=" * 60)
        ...
        print("-" * 60)
        if all_passed:
            print("🎉 OVERALL STATUS: Bing.com is FULLY ACCESSIBLE")
            return 0
        else:
            print("⚠️  OVERALL STATUS: Bing.com has CONNECTIVITY ISSUES")
            return 1
